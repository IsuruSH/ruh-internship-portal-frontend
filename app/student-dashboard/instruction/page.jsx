    ...
    <div className="flex-grow p-6 md:p-8 overflow-y-auto bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Internship Management System Guide</h1>
          <p className="mt-2 text-gray-600">Your comprehensive guide to navigating the platform</p>
        </div>
        ...
        <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100">
          ...
          <div className="mb-8 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
            <p className="text-gray-800">
              Welcome to the <strong className="text-blue-600">Internship Management System</strong>! This
          ...
          <ol className="space-y-8">
            ...
            <li className="p-4 rounded-lg hover:bg-gray-50 transition">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">1. Getting Started</h3>
            ...
            <li className="p-4 rounded-lg hover:bg-gray-50 transition">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">2. Dashboard Overview</h3>
            ...
            <li className="p-4 rounded-lg hover:bg-gray-50 transition">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">3. Analyze Internships</h3>
                  <p className="text-gray-700">
            ...
            <li className="p-4 rounded-lg hover:bg-gray-50 transition">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">14. Logout</h3>
                  <p className="text-gray-700">
